...
export default function Navbar() {
  ...
  return (
    <>
      <nav ref={navRef} className="fixed top-0 left-0 right-0 z-50 pt-6 px-4 md:px-6 flex justify-center pointer-events-none" style={{ opacity: 0, transform: 'translateY(-20px)' }}>
